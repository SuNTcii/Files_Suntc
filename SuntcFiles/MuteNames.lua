...
if DevAbs:get(Suntc.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Suntc.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Suntc.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Suntc.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Suntc.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Suntc.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
SuntcName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if SuntcName then 
SuntcNames = DevAbs:smembers(Suntc.."Abs:Mute:Names"..msg.chat_id_) or ""
if SuntcNames and SuntcNames[1] then 
for i=1,#SuntcNames do 
if SuntcName:match("(.*)("..SuntcNames[i]..")(.*)") then 
...
DevAbs:set(Suntc.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Suntc.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
